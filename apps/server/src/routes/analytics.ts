...
router.get('/projects/:projectId',
    ...
    asyncHandler(async (req, res) => {
        try {
            ...
            // This would return detailed analytics for a specific project
    ...
    asyncHandler(async (req, res) => {
        try {
            ...
            res.json({
                ...
                message: 'נתוני פעילות משתמשים התקבלו בהצלחה'
            })
        } catch (error) {
...
router.get('/files/usage',
    ...
    asyncHandler(async (req, res) => {
        try {
            ...
            // TODO: Implement file usage analytics
            // This would return file upload/download patterns, storage usage, etc.
